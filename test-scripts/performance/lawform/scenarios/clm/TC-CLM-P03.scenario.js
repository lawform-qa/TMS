...
import { gotoReviewList } from '../../actions/clm/clm.navigate.js';
...
export default async function () {
    ...
    await page.screenshot({ path: `screenshots/${ts()}_TC-CLM-P03_review_list.png` });
}

export function handleSummary(data) {
    const timestamp = getFormattedTimestamp().replace(/:/g, '_');
    return { [`Result/TC-CLM-P03_summary_${timestamp}.html`]: htmlReport(data) };
}
